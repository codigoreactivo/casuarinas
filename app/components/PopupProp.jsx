            ...
            <div className="popup-content h-auto flex flex-col gap-2">
                ...
                <div className='flex flex-row justify-between'>
                    <ul className='flex flex-col gap-4 my-3 w-full'>
                        <li className=' w-full flex flex-row justify-between items-center'><p className=' flex items-center justify-start gap-3'>{/*<BsArrowRight className=' rotate-180 bg-green-200 text-black p-3 text-5xl rounded-full' />*/}-Izquierda</p><p className=' text-2xl font-bold text-green-950'>{popupContent.izquierda}m</p></li>
